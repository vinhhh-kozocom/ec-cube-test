...
use Customize\Repository\UserRegisterMetasRepository;
...
class EntryController extends AbstractController
{
    ...
    /**
     * @var UserRegisterMetasRepository
     */
    protected $userRegisterMetasRepo;
     ...
     * @param UserRegisterMetasRepository $userRegisterMetasRepo
     */
    public function __construct(
        ...
        UserRegisterMetasRepository $userRegisterMetasRepo,
    ) {
        ...
        $this->userRegisterMetasRepo = $userRegisterMetasRepo;
    }
            ...
            switch ($request->get('mode')) {
                ...
                case 'complete':
                    ...
                    if ($_SERVER['SERVER_NAME'] !== env('SALON_URL')) {
                        // Create entry user_register_metas
                        $customerId = $Customer->getId();
                        $isAllowRegister = $this->userRegisterMetasRepo->create($customerId);

                        if (!$isAllowRegister) {
                            $this->addError(trans('front.account.limit'), 'front.account.limit');
